    ...
    public class Main {
        public static void main(String[] args) throws ParseException {
            ...
            for(int i=0;i<numberOfInputs;i++){
                ...
                if (signUpcalendar.get(Calendar.YEAR) == currentCalendar.get(Calendar.YEAR)) {
                    System.out.println(" No Range");
                } else {
                    signUpcalendar.add(Calendar.DATE, -30);
                    signUpcalendar.set(Calendar.YEAR, currentCalendar.get(Calendar.YEAR));
                    startDate = signUpcalendar.getTime();
                    signUpcalendar.add(Calendar.DATE, 60);
                    endDate = signUpcalendar.getTime();
                    System.out.println();
